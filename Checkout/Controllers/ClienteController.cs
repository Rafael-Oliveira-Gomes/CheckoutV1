...
namespace Checkout.Controllers
{
    ...
    public class ClienteController : ControllerBase
    {
        ...
        //[HttpGet]
        //public async Task<ActionResult<IEnumerable<ClienteComEnderecosDto>>> ListarClientesComEnderecos()
        //{
        //    var clientes = await _clienteService.ListarClientesComEnderecos();
        //    return Ok(clientes);
        //}
